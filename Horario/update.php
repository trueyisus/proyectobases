...
<div class="relative max-w-xl mx-auto">
    ...
    <div class="mt-12">
        <form id="form_horarios" action="#" method="POST"
            ...
            <input type="hidden" value="" id="id_horario_input">
            <div>
...
<script>
    $(function () {
        ...
        const scheduleId = "<?php echo $schedule; ?>"
        $.ajax({
            url: 'http://localhost:10000/horarios/' + scheduleId + '/show',
            success: function (data) {
                console.log(data);
                $("#id_horario_input").val(data.id_horario);
                $("#hora_salida_input").val(data.hora_salida);
                $("#hora_llegada_input").val(data.hora_llegada);
                $("#lugar_inicio_input").val(data.lugar_inicio);
                $("#lugar_fin_input").val(data.lugar_fin);
            },
        ...
        $("#form_horarios").on('submit', function (event) {
            ...
            let formData = {
                ...
                'id_horario': $("#id_horario_input").val(),
