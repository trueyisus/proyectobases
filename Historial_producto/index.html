...
<head>
    ...
    <title>Historial producto</title>
        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-8"><h2>Historial Productos</h2></div>
                        <div class="col-sm-4">
                ...
                <table class="table table-striped table-hover table-bordered">
                    <thead>
                        <tr>
                            <th>Id producto</th>
                            <th>Precio del producto<i class="fa fa-sort"></i></th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title" id="exampleModalLabel">Editar Hisotria de cambios</h3>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="fechaCambio"/>
                    </div>
                </div>
