    ...
    <script>
        $(document).ready(function(){
            ...
            $(".delete").on("click", function(){
                ...
                $('#contenidoModalEliminar').html("<p>¿Esta seguro que quiere eliminar la importacion con id "+idClienteEliminar+"?</p>");
        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-8"><h2>IMPORTACION</h2></div>
                        <div class="col-sm-4">
                ...
                <table class="table table-striped table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>Id_Producto</th>
                            <th>Id_Almacen <i class="fa fa-sort"></i></th>
                            <th>Precio</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title" id="exampleModalLabel">Editar IMPORTACION</h3>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="nombreCliente">Id_Importacion</label>
                        <input type="text" class="form-control" id="nombreCliente">
                    </div>
                    <div class="form-group">
                        <label for="apellidoPCliente">Id_Producto</label>
                        <input type="text" class="form-control" id="apellidoPCliente" >
                    </div>
                    <div class="form-group">
                        <label for="apellidoMCliente">Id_Almacen</label>
                        <input type="text" class="form-control" id="apellidoMCliente">
                    </div>
                    <div class="form-group">
                        <label for="telefonoCliente">Precio</label>
                        <input type="text" class="form-control" id="telefonoCliente">
                    </div>
                    <div class="form-group">
                        <label for="correoCliente">Fecha</label>
                        <input type="email" class="form-control" id="correoCliente">
                    </div>
                    <div class="form-group">
                        <label for="direccionCliente">Origen</label>
                        <input type="text" class="form-control" id="direccionCliente">
                    </div>
                    <div class="form-group">
                        <label for="direccionCliente">Destino</label>
                        <input type="text" class="form-control" id="direccionCliente">
                    </div>
                </div>
